...
public class Print {
	...
	public static Print[] readMongoResult(String response){
		String[] responseStrings = response.split("<br /><br />");
		Print[] prints = new Print[responseStrings.length];
		for(int i = 0; i<responseStrings.length; i++){
			Print print = new Print(responseStrings[i]);
			prints[i] = print;
		}
